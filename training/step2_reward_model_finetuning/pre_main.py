...
def main():
    ...
    rm_model = create_critic_model(args.model_name_or_path, tokenizer, None,
    ...
    print_rank_0(
        ...
        args.global_rank)
    draw(chosen_list, reject_list, output_path=f'{args.output_dir}/img/score_distribution_init')
    exit()
    for epoch in range(args.num_train_epochs):
        ...
        print_rank_0(
            f"chosen_last_scores (higher is better) : {reward_score}, acc (higher is better) : {acc}",
            args.global_rank)
        draw(chosen_list,reject_list,output_path=f'{args.output_dir}/img/score_distribution_{epoch}')
